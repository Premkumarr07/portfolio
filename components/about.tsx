    ...
    <section id="about" className="py-20 bg-gradient-to-b from-[#f8f9fa] to-[#e9ecef]">
      <div className="container mx-auto px-4">
        ...
        <div className="flex justify-center mb-6">
          <div className="relative w-40 h-40 rounded-full border-4 border-[#FF9500] overflow-hidden shadow-lg">
            <div className="absolute inset-0 border-4 border-dashed border-[#FF9500] rounded-full animate-slow-spin"></div>
            <Image
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="bg-white rounded-lg p-6 border border-[#FF9500] mb-6">
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-6">
            <div className="bg-[#fff8f0] p-4 rounded-lg border border-[#FF9500]">
              <p className="text-sm text-[#FF9500] font-semibold">Education</p>
            ...
            <div className="bg-[#fff8f0] p-4 rounded-lg border border-[#FF9500]">
              <p className="text-sm text-[#FF9500] font-semibold">Certifications</p>
              <p className="text-[#343a40] font-semibold">Android Development</p>
              <p className="text-sm text-[#343a40]">UI/UX Design (Figma)</p>
            </div>
            <div className="bg-[#fff8f0] p-4 rounded-lg border border-[#FF9500]">
              <p className="text-sm text-[#FF9500] font-semibold">Languages</p>
        ...
        <div className="flex justify-center mt-6">
          <a
            href="/Prem_Kumar.pdf"
            download
            className="px-6 py-3 bg-[#FF9500] text-white font-semibold text-lg rounded-lg shadow-md hover:bg-[#E68A00] transition-all duration-300 flex items-center"
          >
        ...
        <div className="flex justify-center space-x-6 mt-6">
          <a
            ...
            className="text-[#343a40] hover:text-[#FF9500] transition-all"
          >
